...
public class CarController {
    ...
    public Car findOneCar(){
        Car car = new Car(1,"toyo",1999.89F,new Date(),"","");
        return car;
    }
    ...
    public Car getCarById1(Car car) {
        return car;
    }
    @InitBinder
    private void initBinder(WebDataBinder webDataBinder){	        webDataBinder.addCustomFormatter(new DateFormatter("yyyy-MM-dd HH:mm:ss"));
    }
